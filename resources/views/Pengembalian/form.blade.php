		...
		<form action = "{{ url('PeminjamanU') }}" method = "POST">
			...
			<div class = "form-group">
				...
				<label for = "kelas">Kelas</label>
					<input type = "text" class = "form-control" name = "kelas" value = "{{ old('kelas', @$pengembalian->kelas) }}" placeholder="Masukkan Kelas" required pattern ="[1]+([1-3]{3})" title ="Enter Kelas Format Example 10"/>
