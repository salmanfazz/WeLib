	...
	<body>
		<div id="content">
			<div id="content-header">
				<div id="breadcrumb"> <a href="{{ url('home') }}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ url('Peminjaman') }}" class="current">Data Peminjaman</a> </div>
					<div class = "container">
							@if(session('success'))
